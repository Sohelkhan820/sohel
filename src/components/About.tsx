        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 items-center">
          ...
          >
            ...
            <div className="relative z-10 aspect-[4/5] rounded-[2rem] overflow-hidden border border-white/5 glass-dark glow-lg group">
              <img 
                src="/images/sohelkhan.png"
                alt="Sohel Khan | Video Editor & Motion Designer" 
          ...
          >
            <h2 className="text-2xl md:text-5xl font-display font-medium mb-4 sm:mb-6 text-text-pure tracking-tighter leading-[1.1]">
              Sohel  <span className="text-accent font-light">Khan</span> <br />
            </h2>
            ...
            <p className="text-xs md:text-lg text-text-soft mb-6 sm:mb-10 leading-relaxed font-light">
             Hi, I'm Md. Sohel Khan. I grew up watching movies and studying how a great story is told, shot by shot — and that's the eye I bring to every video I edit. With 1+ year editing YouTube videos, talking-heads, documentaries, and ads, I turn raw footage into videos people can't stop watching. Fast delivery, clear communication, and quality you can count on — every single time. Let's bring your story to life.
<br/>
            </p>
