...
export default function WhyHireMe() {
  return (
    <section id="why-hire" className="py-25 bg-primary relative overflow-hidden">
      {/* Background Glower */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-8 leading-tight text-text-pure tracking-tighter">
